...
function appStart() {
  const goodDisplayGameOver = () => {
    ...
    div.innerText = "💖 정답 ";
    div.style =
      "display:flex ; justify-content: center; align-items:center; position: absolute; top:40vh; left:34vw; background-color:white; width:200px; height:100px; border-radius: 10px; transition: all 1s; ";
  ...
  const bedDisplayGameOver = () => {
    ...
    div.innerText = " 😜🤔 ";
    div.style =
      "display:flex ; justify-content: center; align-items:center; position: absolute; top:40vh; left:34vw; background-color:white; width:200px; height:100px; border-radius: 10px; ";
    document.body.appendChild(div);
  };
